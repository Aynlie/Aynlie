...
- 👩‍💻 Passionate about **aesthetic code** and **user-first design**
- 🎀 Turning pixels into personality
- 💼 Currently working on:
  - ✨ `BlushBoard`: Survey form 
  - 💕 `StyledComponents BarbieKit`: Portfolio page
  - 📱 `ElleWeather`: A website for girl's community
